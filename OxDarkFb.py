...
def loginSC():
	...
	if username =="Mr.UnderOx" and password =="666":
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/Mas Capt Official')
				menu()
